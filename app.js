...
app.post("/api/questions/add",IsAuthenticated,controllers.api.questionsAdd);

//Questions
app.get("/questions",IsAuthenticated,controllers.questions.homeGet);

//Video Tutorials
app.get("/video-tutorials",IsAuthenticated,controllers.videotutorials.homeGet);

//Profile
app.get("/profile",IsAuthenticated,controllers.profile.homeGet);
